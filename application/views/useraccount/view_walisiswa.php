...
<div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
    <form id="general-info" class="section general-info"  enctype='multipart/form-data' action="<?php echo base_url().'useraccount/updatewaliswa' ?>" method="post">
        <div class="info">
                        ...
                        <div class="col-xl-10 col-lg-12 col-md-8 mt-md-0 mt-4"> 
                            <div class="form">
                                ...
                                <div class="form-group col-md-8">
                                    <label for="inputAddress3">Nama Wali Siswa</label> 
                                    <input name='guid_walisiswa' type="hidden" value="<?php echo $loaddata['guid_walisiswa'] ?>"/>
                                    <input name='walisiswa_bef' type="hidden" value="<?php echo $loaddata['nama_walisiswa'] ?>"/> 
                                    <input name="walisiswa" type="text" required class="form-control" id="inputState3" placeholder="Nama Walisiswa" value="<?php echo $loaddata['nama_walisiswa'] ?>">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input value="<?php echo $loaddata['tempat_lahir'] ?>" required name="tempat_lahir" type="text" class="form-control" id="inputState3" placeholder="Tempat Kelahiran"> 
                                </div> 

                                <div class="form-group col-md-4">
                                    <label for="inputAddress3">Tanggal Kelahiran</label>
                                    <input value="<?php echo $loaddata['tanggal_lahir'] ?>" required name="tanggal_lahir" type="date" class="form-control" id="inputState3" placeholder="Tanggal Kelahiran"> 
                                    <input value="<?php echo $loaddata['tanggal_lahir'] ?>" required name="tanggal_lahir_bef" type="hidden" class="form-control" id="inputState3" placeholder="Tanggal Kelahiran"> 
                                </div>   
                                
                                
                                <div class="form-group col-md-4">
                                    <label for="inputAddress3">Pekerjaan</label>
                                    <input value="<?php echo $loaddata['pekerjaan'] ?>" required name="pekerjaan" type="text" class="form-control" id="inputState3" placeholder="Pekerjaan"> 
                                </div>  
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="kode_walisiswa" type="hidden" class="form-control" id="inputState3"  value="<?php echo $loaddata['kode_walisiswa'] ?>">
                                </div> 
                            ...
                            <div class="form">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input name='kode_user' type="hidden" value="<?php echo $loaddata['kode_walisiswa'] ?>"/>   
