...
<div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
    <form id="general-info" class="section general-info"  enctype='multipart/form-data' action="<?php echo base_url().'useraccount/updatekaryawan' ?>" method="post">
        <div class="info">
                        ...
                        <div class="col-xl-10 col-lg-12 col-md-8 mt-md-0 mt-4"> 
                            <div class="form">
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <input name="karyawan" type="text" required class="form-control" id="inputState3" placeholder="Nama Karyawan" value="<?php echo $loaddata['nama_karyawan'] ?>"> 
                                </div>  

                                <div class="form-group col-md-4">
                                    <label for="inputAddress3">Nik Pegawai</label>  
                                    <input name="nik_karyawan" type="text" required class="form-control" id="inputState3" placeholder="NIK Karyawan" value="<?php echo $loaddata['nik_karyawan'] ?>"> 
                                </div>  
                            ...
                            <div class="form">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input name='kode_user' type="hidden" value="<?php echo $loaddata['kode_karyawan'] ?>"/>   
