...
<div class="col-xl-12 col-lg-12 col-sm-12 col-12 layout-spacing"> 
    ...
    <span  class="btn btn-outline-primary"  data-toggle="modal" data-target=".bd-example-modal-lg">
        Response 
    </span>   
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Response Keluhan</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                </button>
            </div>
            <div class="modal-body">
            <form enctype='multipart/form-data' action="<?php echo base_url().'keluhancs/addresponse' ?>" method="post">
                <div class="form-row mb-4">
                    
					<input type="hidden" name="guidkeluhan" value="<?php echo $guid_keluhan ?>">
					<input type="hidden" name="guiduser" value="<?php echo base64_decode($this->session->userdata('guid_ses')) ?>">
					
                    <div class="form-group col-md-12">
                        <label for="inputAddress3">Response /  Tanggapan</label>
