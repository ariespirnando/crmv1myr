            ...
            <table class="table table-hover" style="width:100%">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $d['guid_keluhan']?> </td> 
                        <td><?php echo $d['nama_consigne']?> </td> 
                        <td><?php echo $d['nohandpone']."/".$d['email']?></td>
                        <td><?php 
                            if(strlen($d['descripsi'])<=100)
                            {
                              echo $d['descripsi'];
                            }
                            else
                            {
                              $y=substr($d['descripsi'],0,100) . '...';
                              echo $y;
                            }
                            echo $d['descripsi']
                            ?>
                        </td> 
                        <td><?php echo $d['tgl_keluhan']?></td> 
						<td><?php echo $d['tgl_response']?></td> 
                         
                        <td class="text-center"> 
                            <a href="<?php echo base_url().'keluhancs/view_keluhan/'.$d['guid_keluhan'] ?>">
