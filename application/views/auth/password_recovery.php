            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content"> 
                        <h3 class="">Pemulihan <span class="brand-name">Password</span></h3>
                        <p class="signup-link">Aplikasi PJJ</a></p>  
                            ...
                            <div class="form">
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    ...
                                    <div class="field-wrapper">
                                        ...
                                        <span class="btn btn-danger" value="">Kembali</span>
                                        </a>
                                        <span onclick="validasi()" class="btn btn-primary" value="">Reset</span> 
                                    </div>
...
Snackbar.show({
    text: 'Silahkan isi email anda, untuk melakukan perubahan password',
    actionTextColor: '#fff',
