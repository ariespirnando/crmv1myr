                        ...
                        <form class="text-left" > 
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="username" name="username" type="text" class="form-control" placeholder="E-Mail / No Handphone">
                                </div>
...
function login(){  
    ...
    if(user!=""){  
        if(capc!=""){  
            ...
            $.ajax({
                url: '<?php echo base_url()?>auth/'+window.atob('Y29uc2lnbmVlX2F1dGg='),
                type: 'post', 
                dataType: "json",
                data: {
                        "username":username, 
