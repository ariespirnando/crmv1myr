                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <span  onclick="load_edit('<?php echo $d['guid_produk']?>')" class="btn btn-outline-primary"  data-toggle="modal" data-target=".bd-edit-lg2">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Edit Produk</h5>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form enctype='multipart/form-data' action="<?php echo base_url().'produk/delete' ?>" method="post">
...
function load_edit(q){
    $.ajax({
        url: '<?php echo base_url()?>produk/loadedit',
        type: 'post', 
        data: "q="+q, 
