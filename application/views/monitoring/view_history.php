...
<div class="col-xl-12 col-lg-12 col-sm-12 col-12 layout-spacing"> 
    ...
    <nav class="breadcrumb-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tagihan Lunas</li>
        </ol> 
    </nav>  
    ...
    <form action="<?php echo base_url().'monitoring/tagihanlunas' ?>" method="post"> 
    ...
    <?php }else{?> 
        ...
        <div class="table-responsive mb-4 mt-4">
            <table class="table table-hover" style="width:100%">
                <thead>
                    <tr>
                    <th class="text-center" style="width:5%"><a href="<?php echo base_url().'monitoring/downloadtagihan/l'?>" class="btn btn-outline-dark">
