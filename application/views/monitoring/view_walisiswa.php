...
<div class="col-xl-12 col-lg-12 col-sm-12 col-12 layout-spacing"> 
    ...
    <nav class="breadcrumb-one" aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="javascript:void(0);"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-cast"><path d="M2 16.1A5 5 0 0 1 5.9 20M2 12.05A9 9 0 0 1 9.95 20M2 8V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-6"></path><line x1="2" y1="20" x2="2.01" y2="20"></line></svg> Monitoring Aktifitas</a></li>
            <li class="breadcrumb-item active" aria-current="page">Wali Siswa</li>
        </ol> 
    </nav>  
    ...
    <form action="<?php echo base_url().'monitoring/walisiswa' ?>" method="post"> 
            ...
            <table class="table table-hover" style="width:100%">
                <thead>
                    ...
                    <th class="text-center">#</th>
                        <th>Kode Wali siswa</th> 
                        <th>Nama Wali siswa</th> 
                        <th>Jenis Kelamin</th>  
                        <th>Status</th> 
                        <th class="text-center" colspan="2">Aktifitas</th>   
                    </tr>
                </thead>
                <tbody>
                <?php
                    $no = $page+1;
                    foreach($datawalisiswa as $d){ 
                ?>
                    <tr>
                        <td class="text-center"><?php echo $no?></td>
                        <td><?php echo $d['kode_walisiswa']?> </td>  
                        <td><?php echo $d['nama_walisiswa']?></td>
                        <td><?php echo $d['jenis_kelamin']?></td> 
                        <td><?php echo $d['status']?></td>  
                        <td class="text-center">
                            <span  onclick="view_siswa('<?php echo $d['kode_walisiswa']?>')" class="btn btn-outline-warning"  data-toggle="modal" data-target=".bd-edit-lg6">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-airplay"><path d="M5 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-1"></path><polygon points="12 15 17 21 7 21 12 15"></polygon></svg>
                            </span>  
                        </td>
                        <td class="text-center"> 
                            <span onclick="send_delete('<?php echo $d['kode_walisiswa']?>')" class="btn btn-outline-dark"  data-toggle="modal" data-target=".bd-edit-lg3">
...
<?php $this->load->view('walisiswa/modal_add') ?>
...
<div class="modal fade bd-edit-lg6" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="clearbody6"><div class="loader dual-loader mx-auto"></div></div>
            </div>
            <div class="modal-footer"> 
...
function load_edit(q){
    $.ajax({
        url: '<?php echo base_url()?>walisiswa/loadedit',
        type: 'post', 
        data: "q="+q, 
...
function view_siswa(q){
    $.ajax({
        url: '<?php echo base_url()?>monitoring/listaktifitas',
        type: 'post', 
        data: "q="+q, 
        success: function(response){
            $('.clearbody6').html(response); 
        }   
    })
} 
function view_edit(q){
    $.ajax({
        url: '<?php echo base_url()?>walisiswa/loadview',
        type: 'post', 
        data: "q="+q, 
        success: function(response){
