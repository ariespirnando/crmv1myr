...
<div class="col-xl-12 col-lg-12 col-sm-12 col-12 layout-spacing"> 
    ...
    <nav class="breadcrumb-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tambah Produk KonsiNyasi / <?php echo $dtconsigne['nama_consigne'] ?></li>
        </ol> 
    </nav>   
    <hr>  
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <span onclick="send_delete('<?php echo $d['guid_produk']?>')" class="btn btn-outline-primary"  data-toggle="modal" data-target=".bd-edit-lg3">
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form enctype='multipart/form-data' action="<?php echo base_url().'konsiyasi/addproduk_k' ?>" method="post">
                ...
                <button type="submit" class="btn btn-primary submit-fn">Add</button>
