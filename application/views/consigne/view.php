...
<div class="col-xl-12 col-lg-12 col-sm-12 col-12 layout-spacing"> 
    ...
    <form action="<?php echo base_url().'consigne' ?>" method="post"> 
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-square"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <span  onclick="load_edit('<?php echo $d['guid_consigne']?>')" class="btn btn-outline-primary"  data-toggle="modal" data-target=".bd-edit-lg2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg>
                            </span>  
                        </td> 
                        <td class="text-center">
                            <span onclick="send_delete('<?php echo $d['guid_consigne']?>')" class="btn btn-outline-danger"  data-toggle="modal" data-target=".bd-edit-lg3">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Edit Consignee</h5>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form enctype='multipart/form-data' action="<?php echo base_url().'consigne/delete' ?>" method="post">
                <input type="hidden" class="deletevalue" name="guid_consigne" value=""/> 
...
<div class="modal fade bd-edit-lg5" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form enctype='multipart/form-data' action="<?php echo base_url().'consigne/resetpass' ?>" method="post">
...
function load_edit(q){
    $.ajax({
        url: '<?php echo base_url()?>consigne/loadedit',
        type: 'post', 
        data: "q="+q, 
...
function view_edit(q){
    $.ajax({
        url: '<?php echo base_url()?>consigne/loadview',
        type: 'post', 
        data: "q="+q, 
        success: function(response){
